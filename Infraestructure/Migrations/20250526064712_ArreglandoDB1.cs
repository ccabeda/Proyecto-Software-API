...
namespace Proyecto_Software_Individual.Migrations
{
    /// <inheritdoc />
    public partial class ArreglandoDB1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_ApproverRoles_Role",
                        column: x => x.Role,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ApprovalRules_ProjectTypes_Type",
                        column: x => x.Type,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectProposals_ApprovalStatuses_Status",
                        column: x => x.Status,
                        principalTable: "ApprovalStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectProposals_Areas_Area",
                        column: x => x.Area,
                        principalTable: "Areas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectProposals_ProjectTypes_Type",
                        column: x => x.Type,
                        principalTable: "ProjectTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectProposals_Users_CreateBy",
                        column: x => x.CreateBy,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    StepOrder = table.Column<int>(type: "int", nullable: false),
                    DesicionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectApprovalSteps_ApprovalStatuses_Status",
                        column: x => x.Status,
                        principalTable: "ApprovalStatuses",
                        principalColumn: "Id",
            ...
            migrationBuilder.InsertData(
                table: "ApprovalRules",
                columns: new[] { "Id", "ApproverRoleId", "AreaId", "MaxAmount", "MinAmount", "StepOrder", "Type" },
                values: new object[,]
                {
                    { 1L, 1, null, 10000m, 0m, 1, null },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectApprovalSteps_Status",
                table: "ProjectApprovalSteps",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectProposals_Area",
                table: "ProjectProposals",
                column: "Area");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectProposals_CreateBy",
                table: "ProjectProposals",
                column: "CreateBy");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectProposals_Status",
                table: "ProjectProposals",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectProposals_Type",
                table: "ProjectProposals",
                column: "Type");
