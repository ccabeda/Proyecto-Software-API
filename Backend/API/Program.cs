...
builder.Services.AddScoped<IUnitOfWorkApprovalRuleQuery, UnitOfWorkCatalogs>();
builder.Services.AddScoped<IUnitOfWorkApprovalStatusQuery, UnitOfWorkCatalogs>();
builder.Services.AddScoped<IUnitOfWorkApproverRoleQuery, UnitOfWorkCatalogs>();
builder.Services.AddScoped<IUnitOfWorkAreaQuery, UnitOfWorkCatalogs>();
builder.Services.AddScoped<IUnitOfWorkProjectApprovalStepCommand, UnitOfWorkProjects>();
builder.Services.AddScoped<IUnitOfWorkProjectApprovalStepQuery, UnitOfWorkProjects>();
builder.Services.AddScoped<IUnitOfWorkProjectProposalCommand, UnitOfWorkProjects>();
builder.Services.AddScoped<IUnitOfWorkProjectProposalQuery, UnitOfWorkProjects>();
builder.Services.AddScoped<IUnitOfWorkProjectTypeQuery, UnitOfWorkCatalogs>();
builder.Services.AddScoped<IUnitOfWorkUserQuery, UnitOfWorkUsers>();
