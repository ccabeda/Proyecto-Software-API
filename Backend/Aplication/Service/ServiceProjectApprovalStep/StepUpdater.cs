...
namespace Proyecto_Software_Individual.Aplication.Service.ServiceProjectApprovalStep
{
    public class StepUpdater //funciones auxiliares
    {
        ...
        public StepUpdater(IUnitOfWorkProjectApprovalStepQuery unitOfWorkProjectApprovalStepQuery, ILogger<StepUpdater> logger, IUnitOfWorkProjectApprovalStepCommand unitOfWorkProjectApprovalStepCommand,
                           IUnitOfWorkProjectProposalCommand unitOfWorkProjectProposalCommand)
        {
        ...
        public async Task UpdateStep(ProjectApprovalStep step, ProjectApprovalStepDesitionDTO stepDTO)
        {
            ...
            await _unitOfWorkProjectApprovalStepCommand._repositoryProjectApprovalStepCommand.Update(step);
        }
