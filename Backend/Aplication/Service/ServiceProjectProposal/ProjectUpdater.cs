...
namespace Proyecto_Software_Individual.Aplication.Service.ServiceProjectProposal
{
    public class ProjectUpdater
    {
        ...
        public ProjectUpdater(IUnitOfWorkProjectProposalQuery unitOfWorkProjectProposalQuery, IUnitOfWorkProjectProposalCommand unitOfWorkProjectProposalCommand, IMapper mapper, ILogger<ServiceProjectProposalCreate> logger)
        {
        ...
        {
            var project = await _unitOfWorkProjectProposalQuery._repositoryProjectProposalQuery.GetById(id);
            if (project == null)
            {
        ...
        public async Task ValidateUpdateData(ProjectProposalUpdateDTO projectProposalDTO, Guid id)
        {
            ...
            var existing = await _unitOfWorkProjectProposalQuery._repositoryProjectProposalQuery.GetByName(projectProposalDTO.Title!);
        ...
        public async Task SaveProject(ProjectProposalUpdateDTO projectProposalDTO, ProjectProposal project)
        {
            ...
            await _unitOfWorkProjectProposalCommand._repositoryProjectProposalCommand.Update(project);
            await _unitOfWorkProjectProposalCommand.Save();
        }
    }
}
