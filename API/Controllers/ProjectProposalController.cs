...
namespace Proyecto_Software_Individual.API.Controllers
{
    ...
    public class ProjectProposalController : ControllerBase
    {
        ...
        public async Task<ActionResult> CreateProjectProposal([FromBody] ProjectProposalCreateDTO projectPropsal)
        {
            ...
            return result != null
            ? CreatedAtAction(nameof(GetProjectProposalById), new { id = result.Id }, result) : ControllerHelper.FromStatus(HttpStatusCode.BadRequest, new ProyectInvalidResponse());
        }
        ...
        public async Task<ActionResult> GetProjectProposalById([FromRoute, SwaggerParameter("ID único del proyecto, Example =123e4567-e89b-12d3-a456-426614174000")] Guid id)
        {
            ...
            return result != null
            ? ControllerHelper.FromStatus(HttpStatusCode.OK, result) : ControllerHelper.FromStatus(HttpStatusCode.BadRequest, new ProjectNotExist());
        }
        ...
        public async Task<ActionResult> GetFilteredProposals([FromQuery] ProjectProposalFilterDTO projectProposal)
        {
            ...
            return result != null
            ? ControllerHelper.FromStatus(HttpStatusCode.OK, result) : ControllerHelper.FromStatus(HttpStatusCode.BadRequest, new ProjectNotFound());
        }
        ...
        public async Task<IActionResult> UpdateProject([FromRoute, SwaggerParameter("ID único del proyecto, Example =123e4567-e89b-12d3-a456-426614174000")] Guid id, [FromBody] ProjectProposalUpdateDTO projectProposal)
        {
            try
            {
                ...
                return result != null
                ? ControllerHelper.FromStatus(HttpStatusCode.OK, result) : ControllerHelper.FromStatus(HttpStatusCode.NotFound, new ProjectNotExist());
            }
            ...
            {
                return ControllerHelper.FromStatus(HttpStatusCode.BadRequest, new ProyectUpdateInvalidResponse());
            }
        }
    }
}
